                        ...
                        <div class="row items-center justify-start">
                            ...
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="BHT_NO" type="text" class="form-control" name="BHT_NO" autocompNormal_Treatmente="BHT_NO">
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="Reason_For_Admission" type="text" class="form-control" name="Reason_For_Admission" autocompNormal_Treatmente="Reason_For_Admission">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                                    <label for="Acute_Problem" class="form-label mb-1"><b>{{ __('Acute Problem') }}</b></label>
                                    <input id="Acute_Problem" type="text" class="form-control" name="Acute_Problem" autocompNormal_Treatmente="Acute_Problem">
                                </div>
                            </div>
                        </div>
                        <div class="row items-center justify-start">
                        ...
                        <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="Treatment_on_Discharge" class="form-select" name="Treatment_on_Discharge">
                                        ...
                                        <option value="Normal_Treatment">Normal Treatment</option>
                           ...
                           <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="Special_Treatment" type="text" class="form-control" name="Special_Treatment" autocompNormal_Treatmente="Special_Treatment">
                                </div>
                            </div>
                        </div>
