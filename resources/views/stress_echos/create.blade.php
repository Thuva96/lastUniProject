    ...
    <div class="max-w-7xl mx-auto lg:px-6 lg:px-8 mb-3">
        <div class="bg-dark overflow-hidden shadow-sm sm:rounded-lg mb-3">
            <div class="card border-dark" style="margin:10px;">
                <div class="card-header font-semibold text-lg">{{ __('Create a Stress Echo investigations for patient') }}</div>
                <div class="card-body text-dark">
                    ...
                    @endif
                    <form action="{{ route('stress_echos.store') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="Findings" type="text" class="form-control" name="Findings" autocomplete="Findings">
                        </div>

                        <div class="row mt-2 item-center">
                            <div class="col">
                                <button type="submit" class="btn btn-primary btn-lg" style="float: right; width: 200px;">
                                    {{ __('Create Stress Echo Investication') }}
                                </button>
                            </div>
                            <div class="col">
