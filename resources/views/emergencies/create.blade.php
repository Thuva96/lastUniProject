    ...
    <div class="max-w-7xl mx-auto lg:px-6 lg:px-8 mb-3">
        <div class="bg-dark overflow-hidden shadow-sm sm:rounded-lg mb-3">
            <div class="card border-dark" style="margin:10px;">
                <div class="card-header font-semibold text-lg">{{ __('Create emergency details of patient') }}</div>
                <div class="card-body text-dark">
                    ...
                    <form action="{{ route('emergencies.store') }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="relationship" type="text" class="form-control" name="relationship" autocomplete="relationship">
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="contact_no" type="text" class="form-control" name="contact_no" autocomplete="contact_no">
