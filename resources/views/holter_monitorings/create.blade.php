    ...
    <div class="max-w-7xl mx-auto lg:px-6 lg:px-8 mb-3">
        <div class="bg-dark overflow-hidden shadow-sm sm:rounded-lg mb-3">
            <div class="card border-dark" style="margin:10px;">
                <div class="card-header font-semibold text-lg">{{ __('Create a holter monitoring for patient') }}</div>
                <div class="card-body text-dark">
                    ...
                    @endif
                    <form action="{{ route('holter_monitorings.store') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="Conclusion" type="text" class="form-control" name="Conclusion" autocomplete="Conclusion">
                        </div>
                        <div class="form-group mb-3">
